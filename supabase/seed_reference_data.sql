...
-- financial_statement_templates(표준 재무제표 양식 라인)는 seeds/financial_statement_templates.sql이
-- 단일 출처이며, 서버 시작 시(init_db) SQLite/Postgres 양쪽에 자동 upsert되므로 여기서 시드하지 않습니다.
